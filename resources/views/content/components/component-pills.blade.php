      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul class="nav nav-pills">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab" data-bs-toggle="pill" href="#home" aria-expanded="true">Home</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" id="dropdown1-tab" href="#dropdown1" data-bs-toggle="pill" aria-expanded="true"
                  >@fat</a
                >
                <a class="dropdown-item" id="dropdown2-tab" href="#dropdown2" data-bs-toggle="pill" aria-expanded="true"
                  >@mdo</a
                >
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" id="about-tab" data-bs-toggle="pill" href="#about" aria-expanded="false">About</a>
            </li>
          </ul>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab-fill" data-bs-toggle="pill" href="#home-fill" aria-expanded="true"
                >Home</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" id="profile-tab-fill" data-bs-toggle="pill" href="#profile-fill" aria-expanded="false"
                >Profile</a
              >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="about-tab-fill" data-bs-toggle="pill" href="#about-fill" aria-expanded="false"
                >About</a
              >
            </li>
          </ul>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul class="nav nav-pills justify-content-center">
            <li class="nav-item">
              <a class="nav-link" id="home-tab-center" data-bs-toggle="pill" href="#home-center" aria-expanded="true"
                >Home</a
              >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" id="about-tab-center" data-bs-toggle="pill" href="#about-center" aria-expanded="false"
                >About</a
              >
            </li>
          </ul>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul class="nav nav-pills justify-content-end">
            <li class="nav-item">
              <a class="nav-link" id="home-tab-end" data-bs-toggle="pill" href="#home-end" aria-expanded="true">Home</a>
            </li>
            <li class="nav-item">
              <a
                class="nav-link active"
            ...
            <li class="nav-item">
              <a class="nav-link" id="about-tab-end" data-bs-toggle="pill" href="#about-end" aria-expanded="false"
                >About</a
              >
            </li>
          </ul>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <ul class="nav nav-pills nav-pill-success my-2">
            <li class="nav-item">
              <a class="nav-link active" href="#" data-bs-toggle="pill" aria-expanded="false">Active</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="pill" aria-expanded="false">Link</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" data-bs-toggle="pill" aria-expanded="false">Link</a>
            </li>
