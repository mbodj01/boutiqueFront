      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <p>
                Add <code>.input-group-lg</code> and <code>.input-group-sm</code> class for touchspin large and small
                respectively.
              </p>
              <div class="demo-inline-spacing">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <p>
                Set <code>data-bts-step</code> and <code>data-bts-decimals</code> attributes for decimal type Input
                Touchspin.
              </p>
              <div class="input-group">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12">
              <p>
                Set <code>data-bts-button-down-class</code> &amp; <code>data-bts-button-up-class</code> attribute and
                add value as <code>btn btn-{color}</code> for different colors spinner.
              </p>
              <div class="demo-inline-spacing">
                <div class="input-group">
                  <input
